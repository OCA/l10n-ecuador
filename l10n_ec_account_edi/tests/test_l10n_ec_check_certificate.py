        ...
        cls.cert2 = cert.create(
            {
                "name": "Cert 2",
                "file_name": "cert2.p12",
                "expire_date": fields.Date.context_today(cert) + timedelta(days=31),
                "state": "valid",
            }
        )
        ...
        cls.cert4 = cert.create(
            {
                "name": "Cert 4",
                "file_name": "cert4.p12",
                "expire_date": fields.Date.context_today(cert) + timedelta(days=60),
        ...
        cls.cert5 = cert.create(
            {
                "name": "Cert 5",
                "file_name": "cert5.p12",
                "expire_date": fields.Date.context_today(cert) - timedelta(days=1),
