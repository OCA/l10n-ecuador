...
class TestL10nECCommon(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref="ec"):
        ...
        # Buscar el journal de liquidación de compra de forma dinámica
        cls.journal_purchase = cls.Journal.search(
            [
                ("type", "=", "purchase"),
        ...
        # Si no existe, crear uno o usar el journal de compra por defecto
        if not cls.journal_purchase:
            cls.journal_purchase = cls.company_data.get("default_journal_purchase")
